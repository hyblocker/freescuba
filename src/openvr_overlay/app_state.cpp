...
AppState::AppState() {
    ...
    gloveLeft.gloveBattery                          = GLOVE_BATTERY_INVALID;
    gloveLeft.gloveBatteryRaw                       = GLOVE_BATTERY_INVALID;
    gloveRight.gloveBattery                         = GLOVE_BATTERY_INVALID;
    gloveRight.gloveBatteryRaw                      = GLOVE_BATTERY_INVALID;
}